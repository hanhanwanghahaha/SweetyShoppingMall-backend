...
<html>
	...
	<body>
		<form action="/SweetyManage/proadd" method="post" enctype="multipart/form-data">
			<p class="path">甜甜屋商城/产品中心/发布产品</p>
			<table border="0" cellspacing="0" cellpadding="0" class="tb">
				<tr>
					<td class="lable">类别</td><td>
					    <select name="typeid">
					    	<option value="1">饼干</option>
					    	<option value="2">泡芙</option>
					    	<option value="3">千层蛋糕</option>
					    	<option value="4">甜甜圈</option>
					    	<option value="5">草莓大福</option>
					    	<option value="6">马卡龙</option>
					    	<option value="7">纸杯蛋糕</option>
					    	<option value="8">彩虹蛋糕</option>
					    	<option value="9">芝士蛋糕</option>
					    </select>
				    </td>
				</tr>

...
%>
<p class="path">甜甜屋商城系统/产品中心/产品列表</p>
...
<table border="0" cellspacing="0" cellpadding="0" class="tb tblis">
    ...
    <script type="text/javascript">
    	$("td.typename").each(function(index,item){
    		...
    		switch(typeid)
    		{
    			case "1":$(item).text("饼干"); break;
    			case "2":$(item).text("泡芙"); break;
    			case "3":$(item).text("千层蛋糕"); break;
    			case "4":$(item).text("甜甜圈"); break;
    			case "5":$(item).text("草莓大福"); break;
    			case "6":$(item).text("马卡龙"); break;
    			case "7":$(item).text("纸杯蛋糕"); break;
    			case "8":$(item).text("彩虹蛋糕"); break;
    			case "9":$(item).text("芝士蛋糕"); break;
    		}
    	});
    </script>
